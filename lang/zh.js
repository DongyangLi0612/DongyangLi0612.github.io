...
已在国际顶级会议和期刊上发表30余篇论文，包括ACL、AAAI、EMNLP、COLING、ICRA、KBS、ECAI 等。
    </p>
    <h2 class='title'> Research Interests </h2>
    <p><span style="color: rgb(178,102,165);">招收硕士研究生，如有兴趣欢迎联系沟通！</span> </p>
    <ul>
      <li> 大模型（文本模态、多模态）</li>
      <li> 多智能体</li>
      <li> 知识增强的语言模型 </li>
...
const zhPublicationsPageData = {
  ...
  type_one_items: [
    ...
    },
    {
      ...
      writers: ["<strong>[ADMA 2025, CCF-C]</strong>",],
    },
    {
