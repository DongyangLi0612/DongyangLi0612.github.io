...
const zhHomePageData = {
  ...
  home_content: `
  <div>
    <p> 我是上海电力大学人工智能学院的一名讲师。我在华东师范大学（ECNU）获得博士学位，导师为何晓丰教授。
目前，我的研究兴趣包括大语言模型、多模态大语言模型以及多智能体系统。
我已在国际顶级会议和期刊上发表了20余篇论文，包括 ACL、AAAI、EMNLP、COLING、KBS、ECAI 等。
    </p>
    <h2 class='title'> Research Interests </h2>
    <p>招收具有硕士研究生，如有兴趣欢迎联系沟通！ </p>
    <ul>
      <li> 大模型（文本模态、多模态）</li>
      <li> 多智能体</li>
      <li> 知识增强的语言模型 </li>
